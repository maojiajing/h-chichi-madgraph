...
## 1. Change lifetime and test in Delphes

```
python rerun_lhe_pl.py -i /home/maojiajing/programs/madgraph_output/MSSM-1d-prod/n3n2-n1-hbb-hbb-0827 -l n3n2-n1-hbb-hbb-0827 -o rerun-n3n2-n1-hbb-hbb-m-scan.sh -n 1000 -b 125 -e 150 -s 25 -pl 1000

#run output
source rerun-n3n2-n1-hbb-hbb-m-scan.sh
```

### 1.1 Change lifetime in lhe file
